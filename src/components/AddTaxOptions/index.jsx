...
const [mouseOver, setMouseOver] = useState(false)
  return (
    ...
    onMouseLeave={() => setMouseOver(false)}>
      {selected?<Icon icon="bi:check-circle-fill" color="#f26419" width="20" height="20" />: mouseOver?<Icon icon="fluent:radio-button-24-regular" color="#f26419" width="24" height="24" />:
